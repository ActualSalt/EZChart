...
INSERT INTO `EZChart`.`Employee` (`E_ID`, `Password`, `FName`, `LName`, `Title`) VALUES ('xXSlayerXx', 'Password', 'Juan', 'Tu', 'Doctor'), ('RNGesus', 'Password', 'Triss', 'Fore', 'Nurse'), ('CNANews', 'Password', 'Shibe', 'Fittz', 'CNA')